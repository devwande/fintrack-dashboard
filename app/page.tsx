...
const Page = () => {
  ...
  const renderPageContent = () => {
    switch (activePage) {
      ...
      case "transactions":
        return <PageNotAvailable pageName="Transactions" />;

      case "report":
        return <PageNotAvailable pageName="Report" />;

      case "settings":
        return <PageNotAvailable pageName="Settings" />;

      default:
        return <PageNotAvailable pageName="Unknown" />;
    }
  };
